const CountryCard = ({ country }) => {
    return (
        <div className="mt-10 w-64 md:w-96 h-full mr-5 card card-compact rounded-none  bg-white border-4 border-[#a6ac92] shadow-xl">
            ...
            <p className="absolute top-20 text-[#5a6f38] text-lg md:text-xl font-semibold bg-[#ccd7af] w-32 p-2 border-2 border-l-0 border-[#a6ac92] rounded-r-full justify-center flex gap-1 items-center">{country.name}</p>
