            ...
            <div className="mt-10 flex flex-col lg:flex-row">
                <div className="md:w-1/2 flex flex-col gap-5 h-full">
                    <div className="flex gap-5 w-full">
                        ...
                        <div className="p-2">
                            <h1 className="text-lg md:text-xl font-semibold text-base-content">Exploring Uncharted Territories: Top Adventure Destinations of the Year</h1>
                    ...
                    <div className="flex gap-5 w-full">
                        ...
                        <div className="p-2">
                            <h1 className="text-lg md:text-xl font-semibold text-base-content">Urban Escapes: Uncovering the Charm of Lesser-Known Cities</h1>
                            <div className="flex gap-5 text-base font-medium">
                                <p className="text-[#657a42]">25 Oct 2021</p>
                                <p className="text-red-500">5min read</p>
                            </div>
                    ...
                    <div className="flex gap-5 w-full">
                        ...
                        <div className="p-2">
                            <h1 className="text-lg md:text-xl font-semibold text-base-content">Eco-Friendly Adventures: Exploring Nature with a Green Mindset</h1>
                            <div className="flex gap-5 text-base font-medium">
                                <p className="text-[#657a42]">25 Oct 2021</p>
                                <p className="text-red-500">5min read</p>
                            </div>
                    ...
                    <div className="flex gap-5 w-full">
                        ...
                        <div className="p-2">
                            <h1 className="text-lg md:text-xl font-semibold text-base-content">Hidden Gems: Off-the-Beaten-Path Destinations for Your Next Trip</h1>
                            <div className="flex gap-5 text-base font-medium">
                                <p className="text-[#657a42]">25 Oct 2021</p>
                                <p className="text-red-500">5min read</p>
                            </div>
